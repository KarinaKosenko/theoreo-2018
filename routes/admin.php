...
//Route::get('/brandsEdit','BrandController@edit')->name('brands.brandsEdit');

Route::get('/brandsEdit/{id}','BrandController@edit')->name('brands.brandsEdit');


Route::get('/brandsCreate','BrandController@create')->name('brands.brandsCreate');
